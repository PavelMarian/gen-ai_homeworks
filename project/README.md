...
python pipeline.py ingest input/reviews\_sample.csv
...
├── tools.py                      # инструменты агента (search, stats, aspects)

├── planner.py                    # планировщик – генерирует план задач

├── researcher.py                 # агент-исследователь (tool use)
...
&#x20;   │   ├── trace.json            # трассировка выполнения (шаги агентов)
